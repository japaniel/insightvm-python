...
class AssetApi(object):
    ...
    def create_asset(self, id, **kwargs):  # noqa: E501
        ...
        :param AssetCreate body: The details of the asset being added or updated. 
...
The operating system can be specified in one of three ways, with the order of precedence: `"osFingerprint"`, `"os"`, `"cpe"`
    ...
    def find_assets(self, body, **kwargs):  # noqa: E501
        """Asset Search  # noqa: E501

        Returns all assets for which you have access that match the given search criteria.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.find_assets(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SearchCriteria body: param1 (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.find_assets_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.find_assets_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def find_assets_with_http_info(self, body, **kwargs):  # noqa: E501
        """Asset Search  # noqa: E501

        Returns all assets for which you have access that match the given search criteria.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.find_assets_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'page', 'size', 'sort']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `find_assets`")  # noqa: E501

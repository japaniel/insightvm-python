...
class AssetGroupApi(object):
    ...
    def create_asset_group(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param AssetGroup body: The details of the asset group.
    ...
    def set_asset_group_search_criteria(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The identifier of the asset group. (required)
        :param SearchCriteria body: The search criteria specification.
        :return: Links
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def set_asset_group_tags(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The identifier of the asset group. (required)
        :param list[int] body: The tags to associate to the asset group.
        :return: Links
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def set_asset_group_users(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The identifier of the asset group. (required)
        :param list[int] body: The users to grant access to the asset group.
        :return: Links
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_asset_group_assets(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The identifier of the asset group. (required)
        :param list[int] body: The assets to place in the asset group. 
        :return: Links
                 If the method is called asynchronously,
                 returns the request thread.
        """

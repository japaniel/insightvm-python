...
class RootApi(object):
    ...
    def resources(self, **kwargs):  # noqa: E501
        ...
        Returns a listing of the resources (endpoints) that are available to be invoked in this API.  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.resources_with_http_info(**kwargs)  # noqa: E501
            return data

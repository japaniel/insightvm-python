...
class PolicyOverrideApi(object):
    ...
    def create_policy_override(self, **kwargs):  # noqa: E501
        ...
        :param PolicyOverride body: The specification of a policy override. Allows users to override the compliance result of a policy rule.
    ...
    def set_policy_override_expiration(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int id: The identifier of the policy override. (required)
        :param str body: The date the policy override is set to expire. Date is represented in ISO 8601 format.
        :return: Links
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def set_policy_override_status(self, id, status, **kwargs):  # noqa: E501
        ...
        :param str body: A comment describing the change of the policy override status.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def set_policy_override_status_with_http_info(self, id, status, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'status', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')

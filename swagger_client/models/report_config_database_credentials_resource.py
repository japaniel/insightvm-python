...
class ReportConfigDatabaseCredentialsResource(object):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ReportConfigDatabaseCredentialsResource, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReportConfigDatabaseCredentialsResource):
            return False

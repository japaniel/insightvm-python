...
# **create_sonar_query**
> CreatedReferenceDiscoveryQueryIDLink create_sonar_query(body)
...
api_instance = swagger_client.AssetDiscoveryApi(swagger_client.ApiClient(configuration))
body = swagger_client.SonarQuery() # SonarQuery | param0

try:
    # Sonar Queries
    api_response = api_instance.create_sonar_query(body)
    pprint(api_response)
...
------------- | ------------- | ------------- | -------------
 **body** | [**SonarQuery**](SonarQuery.md)| param0 | 
...
# **sonar_query_search**
> list[DiscoveryAsset] sonar_query_search(body)
...
# create an instance of the API class
api_instance = swagger_client.AssetDiscoveryApi(swagger_client.ApiClient(configuration))
body = swagger_client.SonarCriteria() # SonarCriteria | param0

try:
    # Sonar Query Search
    api_response = api_instance.sonar_query_search(body)
    pprint(api_response)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**SonarCriteria**](SonarCriteria.md)| param0 | 
...
# **update_sonar_query**
> Links update_sonar_query(body, id)
...
# create an instance of the API class
api_instance = swagger_client.AssetDiscoveryApi(swagger_client.ApiClient(configuration))
body = swagger_client.SonarQuery() # SonarQuery | param1
id = 789 # int | The identifier of the Sonar query.

try:
    # Sonar Query
    api_response = api_instance.update_sonar_query(body, id)
    pprint(api_response)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**SonarQuery**](SonarQuery.md)| param1 | 
 **id** | **int**| The identifier of the Sonar query. | 
